...
|---|---|---|
| Home Assistant integration | Home Assistant (`srvHome`) | free@home integration (jheling or kingsleyadam) |
...
- Static DHCP reservation on `iotCloud` (current: 10.4.20.101)
- DNS override: `sysap.iotCloud.internal` → 10.4.20.101
