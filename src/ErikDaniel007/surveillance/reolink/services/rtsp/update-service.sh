#!/usr/bin/env bash
#
# reolink:rtsp update-service — no-op (policy-only module).
#
...
info "reolink:rtsp update-service for consumer '${CONSUMER}' — no provider-side work needed (auto-pinhole handled by consumer's firewall:rules)."
